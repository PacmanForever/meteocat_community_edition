...
- `test_quota_sensor_entity_id_local_mode`: Verifica que els entity_id són correctes en mode Local
...
- `test_station_comarca_name_sensor`: Verifica sensor de comarca en mode extern
- `test_station_municipality_name_sensor`: Verifica sensor de municipi en mode extern
- `test_station_provincia_name_sensor`: Verifica sensor de província en mode extern
- `test_municipality_latitude_sensor`: Verifica sensor de latitud en mode local
- `test_municipality_longitude_sensor`: Verifica sensor de longitud en mode local
- `test_municipality_provincia_name_sensor`: Verifica sensor de província en mode local

### test_sensor_setup.py
- `test_external_mode_creates_all_geographic_sensors_when_data_available`: Verifica creació de sensors geogràfics en mode extern
- `test_external_mode_skips_municipality_when_not_available`: Verifica omissió de sensors opcionals sense dades
- `test_local_mode_creates_all_sensors_when_data_available`: Verifica creació de sensors en mode local
- `test_local_mode_skips_coordinates_when_not_available`: Verifica omissió de coordenades opcionals
- `test_local_mode_creates_lat_without_lon`: Verifica creació independent de lat/lon

### test_binary_sensor.py (19 tests)
- `test_binary_sensor_initialization_external_mode`: Verifica inicialització en mode extern amb device class problem
- `test_binary_sensor_initialization_local_mode`: Verifica inicialització en mode local
...
- `test_binary_sensor_external_mode_requires_measurements_or_forecast`: Verifica detecció de problemes en mode extern
- `test_binary_sensor_local_mode_requires_forecast`: Verifica detecció de problemes en mode local
- `test_binary_sensor_quota_exhausted_external_mode`: Verifica detecció de quotes exhaurides en mode extern
- `test_binary_sensor_quota_exhausted_local_mode`: Verifica detecció de quotes exhaurides en mode local
- `test_binary_sensor_always_available`: Verifica disponibilitat constant fins i tot quan coordinator falla
- `test_binary_sensor_device_info_external_mode`: Verifica informació de dispositiu en mode extern
- `test_binary_sensor_device_info_local_mode`: Verifica informació de dispositiu en mode local
...
- `test_estacio_first_refresh_tolerates_missing_measurements`: Verifica setup MODE_EXTERNAL amb quotes exhaurides
...
- `test_municipi_first_refresh_tolerates_missing_forecasts`: Verifica setup MODE_LOCAL amb quotes exhaurides
...
- `test_button_entity_id_local_mode`: Verifica que el botó té entity_id correcte en mode Local
