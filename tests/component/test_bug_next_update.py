...
async def test_next_update_value_during_refresh(mock_hass, mock_entry):
    ...
    # We expect the next update to be 14:00
    assert last_seen_value.hour == 14, f"Listener saw next update at {last_seen_value.hour}:{last_seen_value.minute}, expected 14:00"
